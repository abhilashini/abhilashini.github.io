...
<section class="max-w-3xl mx-auto px-4 py-10 section-block hidden" data-section="shared-systems">
  ...
  <p class="text-gray-700 max-w-2xl mx-auto text-center mb-12">
    Complexity in software is often accidental, born from a disconnect between the problem domain and the technical solution. The following studies represent a shift from "feature-building" to "system-stabilizing," specifically within high-volume financial and operational environments.
  </p>
